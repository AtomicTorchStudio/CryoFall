namespace AtomicTorch.CBND.CoreMod.Editor.Scripts
{
    ...
    public static class EditorClientSystem
    {
        ...
        {
            private const double ActionsGroupingMaxTimeIntervalSeconds = 3.0;

            public readonly double TimestampSeconds = Api.Client.Core.ClientRealTime;

            public readonly string Title;

            private readonly List<Action> listDo = new List<Action>(capacity: 1);

            private readonly List<Action> listUndo = new List<Action>(capacity: 1);
