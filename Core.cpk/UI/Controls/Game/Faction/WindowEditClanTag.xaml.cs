namespace AtomicTorch.CBND.CoreMod.UI.Controls.Game.Faction
{
    ...
    [Obsolete("It's no longer functional as the game doesn't allow changing the faction tag after creation")]
    public partial class WindowEditClanTag : BaseUserControlWithWindow
    {
        ...
        private void DoAction()
        {
            ...
            var isError = !FactionSystem.SharedIsValidClanTag(text);
            if (isError)
            {
