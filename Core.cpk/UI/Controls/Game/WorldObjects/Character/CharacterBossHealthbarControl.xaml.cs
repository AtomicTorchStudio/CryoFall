namespace AtomicTorch.CBND.CoreMod.UI.Controls.Game.WorldObjects.Character
{
    ...
    public partial class CharacterBossHealthbarControl : BaseUserControl
    {
        private readonly ICharacter character;

        private ViewModelCharacterBossHealthbarControl viewModel;

        public CharacterBossHealthbarControl(ICharacter character)
        {
        ...
        protected override void OnLoaded()
        {
            ...
            this.DataContext = this.viewModel = new ViewModelCharacterBossHealthbarControl(this.character);
