namespace AtomicTorch.CBND.CoreMod.Events
{
    ...
    public static class ClientWorldEventConsolidatedNotificationManager
    {
        ...
        private class ConsolidatedEventNotification
        {
            ...
            private void RemoveNotification(bool quick)
            {
                ...
                {
                    this.notification.HideAfterDelay(
                        ClientWorldEventRegularNotificationManager.FinishedEventHideDelay);
                }
            }
