namespace AtomicTorch.CBND.CoreMod.Quests
{
    ...
    public class RequirementManufactureItem : QuestRequirementWithList<IProtoItem>
    {
        public const string DescriptionFormat = "Manufacture: {0}";

        public RequirementManufactureItem(
        ...
        public static RequirementManufactureItem Require<TProtoItem>(
            ushort count = 1,
            string description = null)
            where TProtoItem : class, IProtoItem
        {
            var list = Api.FindProtoEntities<TProtoItem>();
            return new RequirementManufactureItem(list,
                                                  count,
                                                  description);
        }
