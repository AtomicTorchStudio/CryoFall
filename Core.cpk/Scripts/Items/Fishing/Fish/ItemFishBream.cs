namespace AtomicTorch.CBND.CoreMod.Items.Fishing
{
    ...
    public class ItemFishBream : ProtoItemFish
    {
        ...
        public override float MaxWeight => 6;

        public override string Name => "Bream";
        ...
        {
            baitWeightList.Add<ItemFishingBaitInsect>(weight: 90)
                          .Add<ItemFishingBaitMix>(weight: 5)
