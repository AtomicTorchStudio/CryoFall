namespace AtomicTorch.CBND.CoreMod.Items.Weapons.Ranged
{
    ...
    public class ItemLaserRifle : ProtoItemWeaponRangedEnergy
    {
        ...
        public override string Description =>
            "Laser rifle emits strong pulses of high-energy light, mostly within the infrared spectrum, that burn the target. Offers much higher range than laser pistol.";
        ...
        protected virtual TextureResource TextureResourceBeam { get; }
            ...
            bool endsWithHit)
        {
            ComponentWeaponEnergyBeam.Create(
                ...
                texture: this.TextureResourceBeam,
                beamWidth: 0.15,
        ...
        protected override void ClientInitialize(ClientInitializeData data)
        {
            ...
            Client.Rendering.PreloadTextureAsync(this.TextureResourceBeam);
        }
        ...
        protected override void PrepareMuzzleFlashDescription(MuzzleFlashDescription description)
        {
            description.Set(MuzzleFlashPresets.EnergyLaserWeaponRedLarge)
                       .Set(textureScreenOffset: (241, 61));
        }
