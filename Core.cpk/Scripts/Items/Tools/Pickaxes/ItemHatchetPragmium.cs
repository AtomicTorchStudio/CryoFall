namespace AtomicTorch.CBND.CoreMod.Items.Tools.Pickaxes
{
    ...
    public class ItemHatchetPragmium : ProtoItemToolPickaxe, IProtoItemToolWoodcutting
    {
        private readonly ReadOnlySoundPreset<ObjectMaterial> PragmiumHatchetHitSoundPreset
            = new SoundPreset<ObjectMaterial>(MaterialHitsSoundPresets.HitSoundDistancePreset)
              .Add(SoftTissues, "Hit/Special/PragmiumHatchet")
              .Add(HardTissues, "Hit/Special/PragmiumHatchet")
              .Add(SolidGround, "Hit/Special/PragmiumHatchet")
              .Add(Vegetation,  "Hit/Special/PragmiumHatchet")
              .Add(Wood,        "Hit/Special/PragmiumHatchet")
              .Add(Stone,       "Hit/Special/PragmiumHatchet")
              .Add(Metal,       "Hit/Special/PragmiumHatchet")
              .Add(Glass,       "Hit/Special/PragmiumHatchet");
        ...
        public override string Description =>
            "This fragile pragmium hatchet uses molecular resonance mechanics, making it much faster than conventional alternatives.";
