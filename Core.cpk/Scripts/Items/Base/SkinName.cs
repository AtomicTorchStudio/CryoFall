namespace AtomicTorch.CBND.CoreMod.Items
{
    ...
    public static class SkinName
    {
        ...
        public const string Aviator = "Aviator";

        public const string Biker = "Biker";

        public const string Buccaneer = "Buccaneer";
        ...
        public const string Cossack = "Cossack";
        ...
        public const string ForestCamo = "Forest camo";
        ...
        public const string Lamellar = "Lamellar";
        ...
        public const string Marauder = "Marauder";
        ...
        public const string Redwood = "Redwood";
        ...
        public const string UrbanCamo = "Urban camo";

        public const string Ushanka = "Ushanka";
