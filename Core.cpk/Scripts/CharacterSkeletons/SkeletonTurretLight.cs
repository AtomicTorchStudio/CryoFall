namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class SkeletonTurretLight : ProtoSkeletonTurret
    {
        public override double DrawWorldPositionOffsetY => 0.24;
        ...
        public override void CreatePhysics(IPhysicsBody physicsBody)
        {
            ...
            physicsBody.AddShapeRectangle(size: (0.9, 0.6), offset: (0.05 - 0.5, 0))
                       ...
                       .AddShapeRectangle(size: (0.7, 0.5), offset: (0.15 - 0.5, 0.75), group: HitboxRanged);
        }

        public override void OnSkeletonCreated(IComponentSkeleton skeleton)
        {
            base.OnSkeletonCreated(skeleton);
            skeleton.DrawOrderOffsetY += 0.45;
        }
    }
}