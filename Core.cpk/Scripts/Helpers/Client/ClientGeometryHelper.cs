namespace AtomicTorch.CBND.CoreMod.Helpers.Client
{
    ...
    public static class ClientGeometryHelper
    {
        /// <summary>
        /// Based on https://wpfspark.wordpress.com/2011/06/08/clipborder-a-wpf-border-that-clips/
        /// </summary>
        public static Geometry GetRectangleGeometryWithRoundedCorners(
            Rect baseRect,
            Thickness thickness,
            CornerRadius cornerRadius)
        {
            ...
            if (topLeftRect.Right > topRightRect.Left)
            {
                ...
                topRightRect = new Rect(baseRect.Left + newWidth,
            ...
            if (topRightRect.Bottom > bottomRightRect.Top)
            {
                var newHeight = (topRightRect.Height / (topRightRect.Height + bottomRightRect.Height))
                                * baseRect.Height;
                topRightRect = new Rect(topRightRect.Location.X,
                                        topRightRect.Location.Y,
                                        topRightRect.Width,
                                        newHeight);
                bottomRightRect = new Rect(bottomRightRect.Location.X,
            ...
            {
                var newWidth = (bottomLeftRect.Width / (bottomLeftRect.Width + bottomRightRect.Width))
                               * baseRect.Width;
                bottomLeftRect = new Rect(bottomLeftRect.Location.X,
                                          bottomLeftRect.Location.Y,
                                          newWidth,
                                          bottomLeftRect.Height);
                bottomRightRect = new Rect(baseRect.Left + newWidth,
            ...
            {
                var newHeight = (topLeftRect.Height / (topLeftRect.Height + bottomLeftRect.Height))
                                * baseRect.Height;
            ...
            // TopLeft Arc
            context.ArcTo(topLeftRect.TopRight,
                          topLeftRect.Size,
                          0,
                          false,
            ...
            // TopRight Arc
            context.ArcTo(topRightRect.BottomRight,
                          topRightRect.Size,
                          0,
                          false,
                          SweepDirection.Clockwise,
            ...
            // BottomRight Arc
            context.ArcTo(bottomRightRect.BottomLeft,
                          bottomRightRect.Size,
                          0,
                          false,
                          SweepDirection.Clockwise,
                          true,
            ...
            // BottomLeft Arc
            context.ArcTo(bottomLeftRect.TopLeft,
                          bottomLeftRect.Size,
                          0,
                          false,
                          SweepDirection.Clockwise,
