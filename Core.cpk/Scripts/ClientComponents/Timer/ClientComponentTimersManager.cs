namespace AtomicTorch.CBND.CoreMod.ClientComponents.Timer
{
    using System;
    ...
    public class ClientComponentTimersManager : ClientComponent
    {
        public static readonly ICoreClientService Core = Client.Core;

        private static ClientComponentTimersManager instance;
        ...
        protected static ClientComponentTimersManager GetOrCreateInstance()
        {
            return instance
                   ?? (instance = Client.Scene
                                        .CreateSceneObject("TimersManager")
                                        .AddComponent<ClientComponentTimersManager>());
        }
