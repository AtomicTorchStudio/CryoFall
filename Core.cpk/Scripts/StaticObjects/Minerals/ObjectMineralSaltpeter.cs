    ...
    public class ObjectMineralSaltpeter : ProtoObjectMineral
    {
        ...
        protected override void PrepareProtoMineral(MineralDropItemsConfig config)
        {
            ...
            config.Stage1
                  ...
                  .Add<ItemPotassiumNitrate>(countRandom: 1, condition: SkillMining.ConditionAdditionalYield);
            ...
            config.Stage4
                  ...
                  .Add<ItemPotassiumNitrate>(countRandom: 5, condition: SkillMining.ConditionAdditionalYield)
