    ...
    public class ObjectMineralIron : ProtoObjectMineral
    {
        ...
        protected override void PrepareProtoMineral(MineralDropItemsConfig config)
        {
            ...
            config.Stage1
                  ...
                  .Add<ItemOreIron>(count: 5)
                  .Add<ItemOreIron>(countRandom: 1, condition: SkillProspecting.ConditionAdditionalYield);
            ...
            config.Stage4
                  ...
                  .Add<ItemOreIron>(count: 10)
                  .Add<ItemOreIron>(countRandom: 5, condition: SkillProspecting.ConditionAdditionalYield)
