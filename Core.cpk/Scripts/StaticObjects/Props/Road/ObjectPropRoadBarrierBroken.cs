namespace AtomicTorch.CBND.CoreMod.StaticObjects.Props.Road
{
    ...
    public class ObjectPropRoadBarrierBroken : ProtoObjectProp
    {
        ...
        {
            data.PhysicsBody
                .AddShapeRectangle(size: (0.25, 0.4), offset: (0.85, 0.6))
                .AddShapeRectangle(size: (0.65, 0.4), offset: (2.9, 0.6))
                .AddShapeRectangle(size: (0.25, 0.6), offset: (0.85, 0.7), group: CollisionGroups.HitboxMelee)
                .AddShapeRectangle(size: (0.65, 0.6), offset: (2.9, 0.7),  group: CollisionGroups.HitboxMelee)
