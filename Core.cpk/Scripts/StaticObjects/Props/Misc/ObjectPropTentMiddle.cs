    ...
    public class ObjectPropTentMiddle : ProtoObjectProp
    {
        ...
        protected override void SharedCreatePhysics(CreatePhysicsData data)
        {
            data.PhysicsBody
                ...
                .AddShapeRectangle(size: (2.8, 1.0), offset: (0.1, 0.0), group: CollisionGroups.HitboxMelee)
                .AddShapeRectangle(size: (2.8, 1.0), offset: (0.1, 0.0), group: CollisionGroups.HitboxRanged);
        }
    }
}