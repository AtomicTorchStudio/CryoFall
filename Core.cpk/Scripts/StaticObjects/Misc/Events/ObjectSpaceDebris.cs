                         ...
                         new DropItemsList(outputs: 3)
                             ...
                             .Add(weight: 1,
                                  nestedList: new DropItemsList(outputs: 2)
                                              ...
                                              .Add<ItemStimpack>(count: 5,         weight: 1)
                             ...
                             .Add(weight: 1 / 2.0,
                                  nestedList: new DropItemsList(outputs: 1)
                                              ...
                                              .Add<ItemGrenadeLauncher>(count: 1,   weight: 1)
                             ...
                             .Add(weight: 1 / 2.0,
                                  nestedList: new DropItemsList(outputs: 1)
                                              ...
                                              .Add<ItemAssaultJacket>(count: 1,     weight: 1)
                                              .Add<ItemAssaultPants>(count: 1,      weight: 1)
                                              ...
                                              .Add<ItemSuperHeavyArmor>(count: 1,   weight: 1 / 3.0)
                                 )
                             // devices
                             .Add(weight: 1 / 5.0,
                                  nestedList: new DropItemsList(outputs: 1)
