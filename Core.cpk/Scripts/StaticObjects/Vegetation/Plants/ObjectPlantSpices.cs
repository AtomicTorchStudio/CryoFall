namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantSpices : ProtoObjectPlant
    {
        public override string Name => "Spices";
        ...
        protected override TimeSpan TimeToGiveHarvest { get; } = TimeSpan.FromHours(4);
        ...
        {
            droplist.Add<ItemSpicesRaw>(count: 2);

            // additional yield
            droplist.Add<ItemSpicesRaw>(count: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemSpicesRaw>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
