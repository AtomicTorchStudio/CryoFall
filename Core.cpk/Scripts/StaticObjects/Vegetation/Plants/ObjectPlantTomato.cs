namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantTomato : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemTomato>(count: 3);

            // additional yield
            droplist.Add<ItemTomato>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemTomato>(count: 2, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
