namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantCucumber : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemCucumber>(count: 3);

            // additional yield
            droplist.Add<ItemCucumber>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemCucumber>(count: 2, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
