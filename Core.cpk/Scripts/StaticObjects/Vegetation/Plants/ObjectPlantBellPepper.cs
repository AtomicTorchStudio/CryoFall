namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantBellPepper : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemBellPepper>(count: 2);

            // additional yield
            droplist.Add<ItemBellPepper>(count: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemBellPepper>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
