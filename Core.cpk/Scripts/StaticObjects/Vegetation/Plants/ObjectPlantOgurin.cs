namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantOgurin : ProtoObjectPlant
    {
        public override string Name => "Ogurin";
        ...
        {
            droplist.Add<ItemOgurin>(count: 2);

            // additional yield
            droplist.Add<ItemOgurin>(count: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemOgurin>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
