namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantRice : ProtoObjectPlant
    {
        public override string Name => "Rice";
        ...
        protected override void ClientSetupRenderer(IComponentSpriteRenderer renderer)
        {
            ...
            ClientGrassRenderingHelper.Setup(renderer, power: 0.1f, pivotY: 0.2f);
        }
        ...
        {
            droplist.Add<ItemRice>(count: 5, countRandom: 5);

            // additional yield
            droplist.Add<ItemRice>(count: 2, countRandom: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemRice>(count: 2,
                                   countRandom: 2,
