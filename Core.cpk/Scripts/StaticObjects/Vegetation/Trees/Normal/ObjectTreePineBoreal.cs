namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Trees
{
    ...
    public class ObjectTreePineBoreal : ProtoObjectTree
    {
        ...
        public override double TreeHeight => 2.4;
        ...
        protected override void PrepareDroplistOnDestroy(DropItemsList droplist)
        {
            ...
            droplist
                .Add<ItemSaplingPineBoreal>(condition: SkillLumbering.ConditionGetSapplings, count: 1, probability: 0.1)
                .Add<ItemSaplingPineBoreal>(condition: SkillLumbering.ConditionGetExtraSapplings,
                                            count: 1,
                                            probability: 0.1);
        }
