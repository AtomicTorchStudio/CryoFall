namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.SmallGatherables
{
    ...
    public class ObjectSmallMushroomPennyBun : ProtoObjectSmallGatherableVegetation
    {
        public override string Name => "Penny bun mushroom";
        ...
        protected override void ClientSetupRenderer(IComponentSpriteRenderer renderer)
        {
            ...
            renderer.DrawOrderOffsetY = 0.21;
        }
        ...
        {
            droplist
                .Add<ItemMushroomPennyBun>(count: 1)
                .Add<ItemMushroomPennyBun>(count: 1,
                                           probability: 1 / 5.0,
