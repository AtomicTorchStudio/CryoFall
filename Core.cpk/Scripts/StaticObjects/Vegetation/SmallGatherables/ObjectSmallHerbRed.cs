namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.SmallGatherables
{
    ...
    public class ObjectSmallHerbRed : ProtoObjectSmallGatherableVegetation
    {
        ...
        {
            droplist
                .Add<ItemHerbRed>(count: 1)
                .Add<ItemHerbRed>(count: 1, probability: 1 / 5.0, condition: SkillForaging.ConditionAdditionalYield);
        }
