namespace AtomicTorch.CBND.CoreMod.CharacterStatusEffects.Debuffs.Client
{
    ...
    public class ClientComponentStatusEffectHeatManager : ClientComponent
    {
        ...
        public static double TargetIntensity
        {
            ...
            set
            {
                    ...
                    && instance == null)
                {
                    ...
                    instance = Client.Scene.CreateSceneObject("Heat visualizer")
                                     .AddComponent<ClientComponentStatusEffectHeatManager>();
                }
            }
        }
        ...
        {
            this.postEffect = ClientPostEffectsManager.Add<PostEffectHeat>();
