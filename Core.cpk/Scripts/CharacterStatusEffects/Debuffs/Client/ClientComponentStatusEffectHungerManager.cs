namespace AtomicTorch.CBND.CoreMod.CharacterStatusEffects.Debuffs.Client
{
    ...
    public class ClientComponentStatusEffectHungerManager : ClientComponent
    {
        private static ClientComponentStatusEffectHungerManager instance;
        ...
        public static double Intensity
        {
            ...
            set
            {
                    ...
                    && instance == null)
                {
                    ...
                    instance = Client.Scene.CreateSceneObject("Hunger visualizer")
                                     .AddComponent<ClientComponentStatusEffectHungerManager>();
                }
            }
        }
        ...
        private class ClientComponentEffectPlayer : ClientComponent
        {
            ...
            private static readonly ReadOnlySoundResourceSet SoundsOccasional
                = new SoundResourceSet().Add("StatusEffects/Debuffs/Hunger/Occasional")
                                        .ToReadOnly();
            ...
            {
                HUDStatusEffectsBar.Instance?.Flicker<StatusEffectHunger>();
            }
