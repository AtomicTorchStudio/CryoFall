namespace AtomicTorch.CBND.CoreMod.CharacterStatusEffects.Invisible
{
    ...
    public class StatusEffectEnvironmentalRadiationTier2 : BaseStatusEffectEnvironmentalRadiation
    {
        protected override IProtoZone ServerZoneProto => Api.GetProtoEntity<ZoneSpecialRadiationTier2>();
            ...
            double currentEffectIntensity)
        {
            ...
            double IncreaseNormal = environmentalRadiationIntensity / 60.0 / 4.5; // 4.5 minutes to reach 100% intensity
