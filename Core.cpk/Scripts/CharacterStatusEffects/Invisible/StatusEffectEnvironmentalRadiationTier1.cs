namespace AtomicTorch.CBND.CoreMod.CharacterStatusEffects.Invisible
{
    ...
    public class StatusEffectEnvironmentalRadiationTier1 : BaseStatusEffectEnvironmentalRadiation
    {
        protected override IProtoZone ServerZoneProto => Api.GetProtoEntity<ZoneSpecialRadiationTier1>();
            ...
            double currentEffectIntensity)
        {
            ...
            double IncreaseNormal = environmentalRadiationIntensity / 60.0 / 6.0; // 6 minutes to reach 100% intensity
