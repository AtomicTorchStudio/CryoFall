namespace AtomicTorch.CBND.CoreMod.Systems.ActiveEventsSystem
{
    ...
    public class ActiveEventsSystem : ProtoSystem<ActiveEventsSystem>
    {
        ...
        [NotLocalizable]
        public override string Name => "Active events system";
