...
namespace AtomicTorch.CBND.CoreMod.Systems.DayNightSystem
{
    ...
    public class ClientTimeOfDayVisualComponent : ClientComponent
    {
        ...
        {
            var timeOfDayHours = DayNightSystem.CurrentTimeOfDayHours;

            var dayFraction = DayNightSystem.IntervalDay.CalculateCurrentFraction(timeOfDayHours);
            var nightFraction = DayNightSystem.IntervalNight.CalculateCurrentFraction(timeOfDayHours);
            var duskDawnFraction = Math.Max(
                DayNightSystem.IntervalDusk.CalculateCurrentFraction(timeOfDayHours),
                DayNightSystem.IntervalDawn.CalculateCurrentFraction(timeOfDayHours));
