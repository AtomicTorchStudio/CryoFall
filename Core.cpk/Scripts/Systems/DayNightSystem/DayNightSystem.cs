namespace AtomicTorch.CBND.CoreMod.Systems.DayNightSystem
{
    ...
    /// </summary>
    public class DayNightSystem : ProtoSystem<DayNightSystem>
    {
        /// <summary>
        ...
        public static bool IsNight => NightFraction > 0.25;
        ...
        private static void ServerSetTimeOfDayOffsetSeconds(double offsetSeconds)
        {
            ...
            Api.Server.Database.Set(nameof(DayNightSystem), nameof(ServerTimeOfDayOffsetSeconds), offsetSeconds);
